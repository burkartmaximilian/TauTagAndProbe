...
class NtuplizerTau : public edm::EDAnalyzer {
    ...
    private:
        ...
        float _byDeepTau2017v2p1VSjetraw;
        ...
        float _byDeepTau2017v2p1VSeraw;
        ...
        float _byDeepTau2017v2p1VSmuraw;
...
void NtuplizerTau::beginJob()
{
    ...
    _tree->Branch("byDeepTau2017v2p1VSjetraw", &_byDeepTau2017v2p1VSjetraw, "byDeepTau2017v2p1VSjetraw/F");
    ...
    _tree->Branch("byDeepTau2017v2p1VSeraw", &_byDeepTau2017v2p1VSeraw, "byDeepTau2017v2p1VSeraw/F");
    ...
    _tree->Branch("byDeepTau2017v2p1VSmuraw", &_byDeepTau2017v2p1VSmuraw, "byDeepTau2017v2p1VSmuraw/F");
...
void NtuplizerTau::analyze(const edm::Event& iEvent, const edm::EventSetup& eSetup)
{
    ...
    _byDeepTau2017v2p1VSjetraw = tau->tauID("byDeepTau2017v2p1VSjetraw");
    ...
    _byDeepTau2017v2p1VSeraw = tau->tauID("byDeepTau2017v2p1VSeraw");
    ...
    _byDeepTau2017v2p1VSmuraw = tau->tauID("byDeepTau2017v2p1VSmuraw");
