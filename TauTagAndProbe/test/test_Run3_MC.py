...
if not isMC: # will use 80X
    ...
    process.load('TauTagAndProbe.TauTagAndProbe.MCanalysis_Run3_cff')
    process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring(
             ...
             "file:///storage/gridka-nrg/mburkart/VBFHToTauTau_Run3_PatatrackTriggerOutput_forEfficiency_forComp_fineSplitting/VBFHToTauTau_M125_TuneCUETP8M1_14TeV_powheg_pythia8/VBFHToTauTau_Run3_PatatrackTriggerOutput_forEfficiency_forComp_fineSplitting/200903_160901/0000/outputFULL_1.root",
        )
    )
