...
if not isMC: # will use 80X
    ...
    process.GlobalTag.globaltag = '110X_mcRun3_2021_realistic_v6' #MC 25 ns miniAODv2
    process.load('TauTagAndProbe.TauTagAndProbe.MCanalysis_Run3_Patatrack_cff')
    process.source = cms.Source("PoolSource",
        fileNames = cms.untracked.vstring(
             ...
             # "file:///storage/gridka-nrg/mburkart/VBFHToTauTau_Run3_PatatrackTriggerOutput_forEfficiency_MenuV11_fineSplitting/VBFHToTauTau_M125_TuneCUETP8M1_14TeV_powheg_pythia8/VBFHToTauTau_Run3_PatatrackTriggerOutput_forEfficiency_MenuV11_fineSplitting/200903_161404/0000/outputFULL_1.root"
             "file:///work/mburkart/TriggerStudies/Patatrack_L2p5Studies/TagAndProbe/CMSSW_11_1_2_patch3/src/TauTagAndProbe/TauTagAndProbe/outputFULL_new.root"
        )
    )
