...
def parse_args():
    ...
    parser.add_argument("-p", "--patatrack", action="store_true",
                        help="Input contains patatrack result.")
...
hltPathTriggered_OS = [n.zeros(1, dtype=int)
                       for x in range(0, numberOfHLTTriggers+1)]
